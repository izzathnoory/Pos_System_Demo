    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-slate-800 text-lg">Payment Checkout Terminal</h2>
            <p className="text-xs text-slate-500">Record customer payment and issue printed tax receipt</p>
          </div>
        </div>
        {selectedOrder && (
          <span className="text-xs font-mono font-bold text-indigo-900 bg-indigo-50 px-3 py-1 rounded-lg">
      ...
      {selectedOrder ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
            ...
            <div className="bg-[#0B4EAE]/10 border border-[#0B4EAE]/20 rounded-xl p-4 text-center">
              <p className="text-xs font-semibold text-[#0B4EAE] uppercase">Total Payable Amount</p>
              <h2 className="text-3xl font-extrabold text-[#0B4EAE] mt-1">
