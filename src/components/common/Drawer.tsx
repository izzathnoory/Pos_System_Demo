  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-0 sm:pl-10">
        <div className="w-screen max-w-full sm:max-w-md bg-white shadow-2xl flex flex-col justify-between z-10 animate-fade-in border-l border-slate-200">
          ...
          {footer && <div className="p-3 sm:p-4 border-t border-slate-100 bg-slate-50/50">{footer}</div>}
        </div>
      </div>
    </div>
  );
